  ...
  var questions = [
    {
      ...
      'text':'How does the proposed transformer model address the vanishing gradient problem in extremely long context windows?',
      'status': 'projecting', // Status: pending, approved, projecting
    },
    {
      'id': '2',
      'sender': 'Anonymous Attendee',
      'text':'Could you elaborate on the ethical implications of using synthetic data to train these moderation algorithms?',
      'status': 'pending',
    },
    {
      'id': '3',
      'sender': 'Markus R.',
      'text': 'Is the latency acceptable for real-time applications like autonomous driving?',
      'status': 'pending',
    },
    {
      'id': '4',
      'sender': 'Sarah J.',
      'text': 'What hardware acceleration is strictly necessary to run this framework locally?',
      'status': 'approved',
    },
    {
      'id': '5',
